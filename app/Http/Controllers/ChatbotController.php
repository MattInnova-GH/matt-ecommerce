...
class ChatbotController extends Controller
{
    private array $dataset = [
        ...
        [
            ...
            'icon'     => 'bot',
            'response' => "Soy el asistente virtual de la tienda. Puedo ayudarte con:\n\n• Información sobre productos\n• Envíos y tiempos de entrega\n• Métodos de pago\n• Estado de pedidos\n• Devoluciones y cambios\n• Tu cuenta y perfil\n\n¿Qué necesitas saber?",
        ],
    ...
    public function respond(Request $request): JsonResponse
    {
        ...
        $result      = $this->findBestResponse($userMessage);
    ...
    private function findBestResponse(string $message): array
    {
        ...
        if ($bestMatch !== null && $bestScore > 0) {
            return ['response' => $bestMatch, 'icon' => $bestIcon];
        }
