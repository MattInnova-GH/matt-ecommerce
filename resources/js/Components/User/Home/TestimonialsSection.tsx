...
function TestimonialCard({ testimonial }: { testimonial: Review }) {
    return (
        <div className="w-80 shrink-0 rounded-xl bg-white p-6 shadow-sm transition-transform hover:scale-[1.02]">
...
export default function TestimonialsSection({ reviews = [] }: Props) {
    ...
    // 4 copies → animamos exactamente -25% (1 copia) sin error de punto flotante
    const displayReviews = shouldAnimate
