import { Store, LogOut, Menu, LayoutDashboard, Users, Package, Tags } from 'lucide-react';
        ...
        >
            <div className={`shrink-0 p-5 border-b border-gray-200 dark:border-zinc-800 ${isCollapsed ? 'px-3' : ''}`}>
                <Link href="/admin" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'}`}>
                    <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg shrink-0">
