                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border-radius:12px; overflow:hidden;">
                    <tr>
                        <td style="background-color:#111827; padding:24px 32px;">
                            <h1 style="margin:0; color:#ffffff; font-size:20px;">¡Gracias por tu compra, {{ $order->user->first_name }}!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 12px; font-size:13px; color:#6b7280;">Método de pago: {{ $order->payment?->method === 'yape' ? 'Yape' : 'Transferencia bancaria' }}</p>
